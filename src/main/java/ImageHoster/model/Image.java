...
public class Image {
    ...
    // one image can have many comments but one comment can belong to just one image so there ie one to many mapping
    //comments will have a list of all the comments of the image
